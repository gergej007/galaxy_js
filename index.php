...
<head>
    ...
    <script type="text/javascript" src="js/collision_detections/bazis_interactions.js"></script>
    <script type="text/javascript" src="js/collision_detections/bazis_shot_interactions.js"></script>
    <script type="text/javascript" src="js/collision_detections/enemy_shot_interactions.js"></script>
    <script type="text/javascript" src="js/collision_detections/enemy_interactions.js"></script>
    <script type="text/javascript" src="js/collision_detections/boss_shot_interactions.js"></script>
